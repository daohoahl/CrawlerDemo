...
├── environments/
│   └── demo/                     # Current deployable environment
├── modules/
│   ├── vpc/                      # VPC, Multi-AZ subnets, NAT, S3 Endpoint
│   ├── ec2/                      # EC2 ASG (worker + web), ECR, scaling
│   ├── s3/                       # Raw + exports buckets
...
# 8. Runtime files are auto-generated by Terraform apply
# (controlled by tfvars: generate_runtime_files=true)
#   environments/demo/.runtime.env
